...
void UploadedSong::initUi()
{
    ...
    connect(m_sortOptMenu,
            ...
            this,
            [this, cloud_sort_toolButton_toolTip](const bool &down) {
                Q_UNUSED(down);
    ...
    connect(m_sortOptMenu,
            ...
            [this, cloud_sort_toolButton_toolTip](const bool &down) {
                ...
                cloud_sort_toolButton_toolTip->setToolTip(down
    ...
    connect(m_sortOptMenu,
            ...
            [this, cloud_sort_toolButton_toolTip](const bool &down) {
                ...
                cloud_sort_toolButton_toolTip->setToolTip(
    ...
    connect(m_sortOptMenu,
            ...
            this,
            [this, cloud_sort_toolButton_toolTip] {
                onRandomSort();                                                         ///< 调用随机排序
